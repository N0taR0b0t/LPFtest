...
def main():
    ...
    geojson_t_output_size = os.path.getsize('geojson_t_output.json') / (1024 * 1024)  # size in MB
    total_size = (linked_places_output_size + geojson_t_output_size)
    print()
    ...
    print(f'geojson_t_output.json size:	{geojson_t_output_size:.2f} MB')
